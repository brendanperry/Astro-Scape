...
public class NCUSTOMspawner : MonoBehaviour
{
	...
	void Awake ()
	{
		...
		normalFire = PlayerPrefsX.GetBool ("normalFireN");
		redFire = PlayerPrefsX.GetBool ("redFireN");
		blueFire = PlayerPrefsX.GetBool ("blueFireN");
		yellowFire = PlayerPrefsX.GetBool ("yellowFireN");
		greenFire = PlayerPrefsX.GetBool ("greenFireN");
		pinkFire = PlayerPrefsX.GetBool ("pinkFireN");

		normalShip = PlayerPrefsX.GetBool ("normalShipN");
		redShip = PlayerPrefsX.GetBool ("redShipN");
		blueShip = PlayerPrefsX.GetBool ("blueShipN");
		yellowShip = PlayerPrefsX.GetBool ("yellowShipN");
		greenShip = PlayerPrefsX.GetBool ("greenShipN");
		pinkShip = PlayerPrefsX.GetBool ("pinkShipN");
	}
